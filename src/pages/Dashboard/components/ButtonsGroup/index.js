    ...
    >
      <MDBCol className="d-flex justify-content-center mx-5">
        <MDBBtn className="btn-block p-4" color="success" type="button">
          <div className="d-flex justify-content-center align-items-center">
            <div className="mx-3">
              <MDBIcon fas icon="file-alt" color="white" size="2x" />
            </div>
            <div>
              <h5 className="text-white m-0">Task assignment</h5>
            </div>
          </div>
        </MDBBtn>
      </MDBCol>
      <MDBCol className="d-flex justify-content-center mx-5">
        <MDBBtn className="btn-block p-4" color="info" type="button">
          <div className="d-flex justify-content-center align-items-center">
            <div className="mx-3">
              <MDBIcon fas icon="comment" color="white" size="2x" />
            </div>
            <div>
              <h5 className="text-white m-0">Message</h5>
            </div>
          </div>
        </MDBBtn>
      </MDBCol>
      <MDBCol className="d-flex justify-content-center mx-5">
        <MDBBtn className="btn-block p-4" color="warning" type="button">
          <div className="d-flex justify-content-center align-items-center">
            <div className="mx-3">
              <MDBIcon fas icon="tasks" color="white" size="2x" />
            </div>
            <div>
              <h5 className="text-white m-0">Create new task</h5>
            </div>
          </div>
        </MDBBtn>
      </MDBCol>
